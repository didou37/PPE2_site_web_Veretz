...
if(isset($_POST['pseudo'],$_POST['mdp'])){//l'utilisateur à cliqué sur "S'inscrire", on demande donc si les champs sont défini avec "isset"
    ...
    } elseif(mysqli_num_rows(mysqli_query($mysqli,"SELECT * FROM compte WHERE identifiantCompte='".$_POST['pseudo']."'"))==1){//on vérifie que ce pseudo n'est pas déjà utilisé par un autre membre
        echo "Ce pseudo est déjà utilisé.";
    } else {
        //toutes les vérifications sont faites, on passe à l'enregistrement dans la base de données:
        //Bien évidement il s'agit là d'un script simplifié au maximum, libre à vous de rajouter des conditions avant l'enregistrement comme la longueur minimum du mot de passe par exemple
        if(!mysqli_query($mysqli,"INSERT INTO compte SET identifiantCompte='".$_POST['pseudo']."', mdpCompte='".$_POST['mdp']."',prenomCompte='".$_POST['prenom']."', nomCompte='".$_POST['nom']."'")){//on crypte le mot de passe avec la fonction propre à PHP: md5()
